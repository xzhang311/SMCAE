function H = GetHomography(im1, im2)
% GetHomography Demonstrates matching two images using SIFT and RANSAC
%
%   GetHomography demonstrates matching two images based on SIFT
%   features and RANSAC and computing their mosaic.
%
%   GetHomography by itself runs the algorithm on two standard test
